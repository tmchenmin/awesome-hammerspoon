...
function showAnalogClock(screen)
    ...
    if not clock.bgcirle then
        ...
        clock.bgcirle = hs.drawing.arc(screen:localToAbsolute(aclockcenter),80,0,360)
        ...
        clock.mincirle = hs.drawing.arc(screen:localToAbsolute(aclockcenter),55,0,360)
        ...
        clock.hourcirle = hs.drawing.arc(screen:localToAbsolute(aclockcenter),40,0,360)
        ...
        clock.sechand = hs.drawing.arc(screen:localToAbsolute(aclockcenter),80,0,0)
        ...
        clock.minhand1 = hs.drawing.arc(screen:localToAbsolute(aclockcenter),55,0,0)
        ...
        clock.minhand1:show()
        clock.minhand2 = hs.drawing.arc(screen:localToAbsolute(aclockcenter),54,0,0)
        ...
        clock.minhand2:show()
        clock.minhand3 = hs.drawing.arc(screen:localToAbsolute(aclockcenter),53,0,0)
        ...
        clock.hourhand1 = hs.drawing.arc(screen:localToAbsolute(aclockcenter),40,0,0)
        ...
        clock.hourhand2 = hs.drawing.arc(screen:localToAbsolute(aclockcenter),39,0,0)
        ...
        clock.hourhand3 = hs.drawing.arc(screen:localToAbsolute(aclockcenter),38,0,0)
